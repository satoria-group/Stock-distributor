<div>
            ...
            <tbody class="divide-y divide-slate-100 bg-white">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="hover:bg-slate-50/80 transition">
                        <td class="px-5 py-3.5 font-bold text-slate-900 text-xs"><?php echo e($user->name); ?></td>
                        <td class="px-5 py-3.5 text-slate-500 font-mono text-xs"><?php echo e($user->email); ?></td>
                        <td class="px-5 py-3.5 text-center">
                            <span class="inline-flex items-center px-2.5 py-1 rounded-full text-[11px] font-bold bg-emerald-50 text-emerald-800 border border-emerald-200">
                                <?php echo e(strtoupper($user->getRoleNames()->first() ?? 'Staff')); ?>

                            </span>
                        </td>
                        <td class="px-5 py-3.5 text-right space-x-1.5">
                            <button type="button" wire:click="openEdit(<?php echo e($user->id); ?>)"
                                    ...
                                    title="Edit User (<?php echo e($user->name); ?>)">
                            ...
                            <button type="button" wire:click="delete(<?php echo e($user->id); ?>)" wire:confirm="Hapus user <?php echo e($user->name); ?>?"
    ...
    <div class="mt-4 pt-2">
        <?php echo e($users->links('livewire::tailwind')); ?>
    ...
    <div class="fixed inset-0 bg-slate-900/50 backdrop-blur-xs flex items-center justify-center z-50 p-4" wire:click.self="$set('showModal', false)">
        <div class="bg-white rounded-3xl shadow-2xl w-full max-w-md p-6 border border-slate-200">
            <h3 class="text-base font-bold text-slate-900 mb-4"><?php echo e($editingId ? 'Edit User' : 'Tambah User'); ?></h3>
